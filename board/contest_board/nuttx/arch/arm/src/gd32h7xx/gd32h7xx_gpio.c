/****************************************************************************
 * arch/arm/src/gd32h7xx/gd32h7xx_gpio.c
 *
...
static void gd32_gpio_clock_enable(uint32_t port_base)
{
  ...
  switch (port_base)
    ...
    default:
      return;
#if GD32_NGPIO_PORTS > 0
    case GD32_GPIOA_BASE:
      rcu_en = RCU_AHB4EN_PAEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 1
    case GD32_GPIOB_BASE:
      rcu_en = RCU_AHB4EN_PBEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 2
    case GD32_GPIOC_BASE:
      rcu_en = RCU_AHB4EN_PCEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 3
    case GD32_GPIOD_BASE:
      rcu_en = RCU_AHB4EN_PDEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 4
    case GD32_GPIOE_BASE:
      rcu_en = RCU_AHB4EN_PEEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 5
    case GD32_GPIOF_BASE:
      rcu_en = RCU_AHB4EN_PFEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 6
    case GD32_GPIOG_BASE:
      rcu_en = RCU_AHB4EN_PGEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 7
    case GD32_GPIOH_BASE:
      rcu_en = RCU_AHB4EN_PHEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 8
    case GD32_GPIOJ_BASE:
      rcu_en = RCU_AHB4EN_PJEN;
      break;
#endif
#if GD32_NGPIO_PORTS > 9
    case GD32_GPIOK_BASE:
      rcu_en = RCU_AHB4EN_PKEN;
      break;
#endif
    }
      ...
      switch (cfgset & GPIO_CFG_SPEED_MASK)
        {
          ...
          /* 12 MHz Low speed output */

          case GPIO_CFG_SPEED_12MHZ:
            setting = GPIO_OSPEED_12MHZ;
            break;

          /* 60 MHz Medium speed output */

          case GPIO_CFG_SPEED_60MHZ:
            setting = GPIO_OSPEED_60MHZ;
            break;

          /* 85 MHz Fast speed output  */

          case GPIO_CFG_SPEED_85MHZ:
            setting = GPIO_OSPEED_85MHZ;
            break;

          /* 100/220 MHz High speed output */

          case GPIO_CFG_SPEED_100_220MHZ:
            setting = GPIO_OSPEED_100_220MHZ;
            break;
        }
    }
