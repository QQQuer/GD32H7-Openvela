/****************************************************************************
 * arch/arm/src/gd32h7xx/gd32h7xx_irq.c
 *
...
void up_irqinitialize(void)
{
  ...
  arm_stack_color(g_intstackalloc, intstack_size);
   ...
   *  1 -> 64 interrupt lines, 16 priority registers
   *  2 -> 96 interrupt lines, 24 priority registers
   *  ...
   */
  ...
  /* If the MPU is present, then attach and enable the Memory Management
   * Fault handler.
   */
